...
public class Main
{
    ...
    {
        BufferedImage originalImage = null;  //Creating a buffered image object to store original image.
        Scanner s = new Scanner(System.in);  //Creating a scanner object to obtain input from the user.
        String decision = null;              //String Variable to store user's decision to embed data or extract data.
        int flag = 0;
